 ...
 * @date 2018-12-09
 */
public class JDK8_Feature {
	public List<Integer> list = (List<Integer>) Arrays.asList(new Integer[] {1,2,3,4,55});
	...
	public void testStream() {
		List<Integer> nums = (List<Integer>) Arrays.asList(new Integer[] {1,2,null,3,4,null,55});
	...
	public class JDK8InterfaceImpl2 implements JDK8Interface2 {
